...
const OnboardScreen = ({navigation}) => {
  ...
  const renderItemDots = useCallback(
    ({item, index}) => {
      // const isLastIndex = index === (currentIndex - 1);
      // const text = isLastIndex ? 'Different Text' : 'Next';
    ...
    <ScrollView
      ...
      /> */}
        ...
        <Touchable style={styles.btnArrow} onPress={goNext}>
          <TextComponent text={currentIndex ?'Start': 'Next'} styles={{color: Colors.secondary,...styles.arrowText}} />
          <View style={{...styles.arrowStyle}}>
          <Image source={arrow} resizeMode="contain" style={{width: wp('6') ,color: Colors.white,...styles.arrowText}} />
          </View>
        </Touchable>
      </View>
    </ScrollView>
